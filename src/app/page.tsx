      ...
      <div className="container mx-auto px-4 py-16 relative z-10">
        <div className="text-center mb-16">
          <h1 className="text-6xl font-bold mb-4 leading-tight creative-heading">
            ...
            <span className="bg-gradient-to-r from-orange-500 via-yellow-500 to-orange-600 bg-clip-text text-transparent font-black mx-3 animated-gradient transform hover:scale-110 inline-block">
              STORAGE
            </span>
